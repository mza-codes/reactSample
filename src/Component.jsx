...
function Component() {
  ...
  return (
    <div className='p-3 mx-auto mb-3 border' >
      ...
      <button onClick={() => setCount(count + 1)} className="m-1 btn btn-warning">Increase</button>
      <h5 className="times">Counter 1st: {count} </h5>
      <button onClick={() => setCount2(count2 + 1)} className="m-1 btn btn-info">Increase</button>
